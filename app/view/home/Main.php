  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 pt-2 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
        <h1>Sua Jornada Digital Começa Aqui!</h1>
        <ul>
          <p class="pt-3">
            Transformando conceitos criativos em:
          </p>
          <li><i class="ri-check-line"></i> Websites dinâmicos</li>
          <li><i class="ri-check-line"></i> Ecommerces envolventes</li>
          <li><i class="ri-check-line"></i> Landing pages irresistíveis</li>
        </ul>
        <div class="mt-3">
          <a href="#about" class="btn-get-started scrollto">Saiba Mais</a>
          <a href="/contato" class="btn-get-quote">Solicitar Orçamento</a>
        </div>
      </div>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4">
          <div class="box">
            <span>01</span>
            <h4>Design e Desenvolvimento de Sites</h4>
            <p>Do minimalismo elegante às interfaces repletas de recursos, nossos especialistas criam websites
              personalizados que representam sua visão de forma única.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 mt-4 mt-lg-0">
          <div class="box">
            <span>02</span>
            <h4>Ecommerces que Impulsionam Vendas</h4>
            <p>Criamos lojas online intuitivas e visualmente atraentes que transformam visitantes em clientes fiéis.
              Garantimos uma jornada de compra impecável.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 mt-4 mt-lg-0">
          <div class="box">
            <span>03</span>
            <h4> Landing Pages que Convertem</h4>
            <p>Nossas landing pages são projetadas para capturar a imaginação dos visitantes instantaneamente.
              Transformamos cliques em conversões.</p>
          </div>
        </div>

        <div class="col-lg-4 mt-4 mt-lg-0 pt-3">
          <div class="box">
            <span>04</span>
            <h4> Criação de Marca Personalizada</h4>
            <p>Seu logotipo é a face da sua empresa. Criamos logotipos que refletem a essência do seu negócio, deixando
              uma marca memorável na mente dos clientes.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 mt-4 mt-lg-0 pt-3">
          <div class="box">
            <span>05</span>
            <h4> Hospedagem Individualizada</h4>
            <p>Garantimos a estabilidade e desempenho do seu site com nossas soluções de hospedagem personalizadas. Cada
              site é tratado com a atenção que merece.</p>
          </div>
        </div>
        ...
        <div class="col-lg-4 mt-4 mt-lg-0 pt-3">
          <div class="box">
            <span>06</span>
            <h4> Contas de E-mails Profissionais</h4>
            <p>Criamos contas de e-mail profissionais com o nome da sua empresa para você e sua equipe, garantindo uma
              comunicação eficaz e confiável com clientes e parceiros.</p>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="150">
          <img src="<?php echo DIRIMG . 'about12.jpg' ?>" class="img-fluid" alt="">
        </div>
        <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
          <h2>Quem Somos</h2>
          <p>
            A LRV Web nasceu da visão de ajudar pequenos empresários a alcançarem o sucesso virtual
            e ampliarem suas vendas online. Nossa jornada é marcada pelo comprometimento em
            transformar sonhos em realidade, capacitando empreendedores a prosperarem em um mundo
            digital em constante evolução.
          </p>
          <p class="pt-2">
            Não somos apenas uma empresa de serviços. Somos parceiros de negócios dedicados a
            auxiliar nossos clientes em sua jornada de crescimento. Ao lado de nossa equipe de
            profissionais talentosos e nossa rede de parceiros, estamos comprometidos em
            construir um futuro digital brilhante e lucrativo.
          </p>
          <p class="pt-3">Vamos Construir o Futuro Juntos!</p>
          <div class="mt-3">
            <a href="#" class="btn-get-quote">Quero Conhecer</a>
          </div>
        </div>
      </div>
  ...
  <section id="services" class="services">
    <div class="container">
      ...
      <div class="section-title">
        ...
        <p>Você imagina, nós construímos. Na LRV Web, 
          transformamos ideias em experiências digitais extraordinárias. 
          Seja um site elegante, uma loja online vibrante ou uma presença 
          única na web, estamos aqui para concretizar sua visão.</p>
      </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-xl-6 pt-4 pt-lg-0 order-1 order-lg-2 content">
          ...
          <p>Para sites, landing pages e lojas online!</p>
        </div>
      </div>
    </div>
  </section>
          ...
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-1.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>Web</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-2.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>App</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-3.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>Card</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-4.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>Web</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-5.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>App</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-6.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>Card</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-7.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>Card</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-8.jpg' ?>" data-gallery="portfolioGallery"
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <div class="portfolio-wrap">
            ...
            <div class="portfolio-info">
              ...
              <p>Web</p>
              <div class="portfolio-links">
                <a href="<?php echo DIRIMG . 'portfolio-9.jpg' ?>" data-gallery="portfolioGallery"
                  class="portfolio-lightbox" title="Web 3"><i class="bx bx-plus"></i></a>
                <a href="portfolio-details.html" title="More Details"><i class="bx bx-link"></i></a>
              </div>
            </div>
